...
\title[Spatial Interpolation. GIS Application `18]{Spatial Interpolation \& Ecotoxicological Risk Assessment with \LARGE{R}\\
\medskip \tiny{GIS Application, Winter Semester 2018}} % The short title appears at the bottom of every slide, the full title is only on the title page

\author[Avit Bhowmik]{Dr. Avit K. Bhowmik \\} % Your name
\institute[Future Earth] % Your institution as it will appear on the bottom of every slide, may be shorthand to save space
{
\textit{avit.bhowmik@futureearth.org}% Your email address
}
\date[\today]{\today \\[0.8cm]
\includegraphics[width=0.35\textwidth]{Figures/FE_logo.png}} % Date, can be changed to a custom date
...
\begin{frame}
\frametitle{A little bit about my research}
Geoinformatics I Spatial Ecotoxicology and Envrionmental Health\\
\hspace{0.3cm} \small \alert{Chemical Pollution Boundary} \hspace{1cm} \alert{Spatial Risk Assessment}\\
\includegraphics[width=0.48\textwidth]{Figures/chempoll.png}
\includegraphics[width=0.48\textwidth]{Figures/rethin.png}
\end{frame}
...
\alert{z(sampled) $\approx$ z(unsampled)}
\end{frame}
...
\href{https://github.com/AvitBhowmik/gisapp18}{\alert{https://github.com/AvitBhowmik/gisapp18}}\\
\vspace{1cm}
...
\begin{column}{0.6\textwidth}
   \textbf{Contact me:}\\
   - Ph.D. / Master's Thesis Topics / Supervision\\
   - Research / Project Assistantships\\
   - Internships @ Future Earth\\
   - General Interests\\[0.3cm]
...
twitter: \href{https://twitter.com/avitbhowmik}{\alert{@avitbhowmik}}\\
   google scholar: \href{https://scholar.google.se/citations?user=laRo5pgAAAAJ&hl=en}{\alert{Publications}}
\end{column}
